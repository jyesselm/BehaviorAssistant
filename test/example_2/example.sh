...
echo "python ../../ba.py --render html --since '1 minute ago' -ro test.html"
python ../../ba.py -m Title --render html --since "1 minute ago" -ro test.html

echo "showing git log"
git --no-pager log --since "1 minute ago"
